...
- Для `peer_id` этих бесед используйте значения, начинающиеся с `2000000001`, `2000000002` и так далее, в соответствии с количеством созданных вами чатов. Например, если вы создали одну беседу, используйте `2000000001`.
